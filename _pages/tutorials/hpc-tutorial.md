...
You can either use the **Input Helper tool, [here](/tutorial/input-helper-tutorial)**, to create all the required files each components, or you can find some templates in the following repository:
